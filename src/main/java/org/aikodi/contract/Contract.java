...
public class Contract {
   ...
   */
  public final static void requireNotNull(Object o) {
    requireNotNull(o, "");
  }
   ...
   */
  public final static void require(boolean bool, String message) {
    if(! bool) {
      throw new IllegalArgumentException(message);
    }
  }
  
  public final static void requireNotNull(Object o, String message) {
   ...
   */
  public final static void requireSaneCollection(Collection<?> collection) {
