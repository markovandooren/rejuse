package be.kuleuven.cs.distrinet.rejuse.event.test;

import java.util.EventListener;
import java.util.EventObject;

import be.kuleuven.cs.distrinet.rejuse.event.EventSourceSupport;
import be.kuleuven.cs.distrinet.rejuse.event.Notifier;
 ...
 * @release $Name$
 */
public class TestTypeApplicabilityNotifier extends JutilTest {
  
  public TestTypeApplicabilityNotifier(String name) {
